...
export default function Products() {
  ...
  return (
    <div className='flex flex-col justify-center bg-gray-200'>
      ...
      <div className='flex justify-center gap-10 items-center px-20 py-5'>
        <h1 className='text-2xl font-row-font  mt-10 text-center mb-10'>Ship-Kart</h1>
        
        <input
          type="text"
          placeholder="Search Products Here"
          className="px-4 py-4 md:block hidden w-1/2 shadow-md text-black text-md rounded-lg focus:outline-none"
          value={searchTerm}
        ...
        {!showModal && (
          <button
            className='px-4 py-2 flex flex-row shadow-md bg-yellow-400 text-black text-xs font-bold uppercase rounded hover:bg-yellow-500 focus:outline-none focus:bg-yellow-600'
            onClick={toggle}
          >
      ...
      <div className='bg-blue-950 text-white'>
        <h1 className='flex md:flex-row flex-col items-center md:justify-center text-4xl font-semibold font-list-font px-10 py-20 text-center'>Welcome  to  Our  Upgraded  Ship-Cart  <BsCart4 size={36} /></h1>
      </div>
